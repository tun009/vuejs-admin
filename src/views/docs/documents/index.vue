      ...
      >
        ...
        <template #actions="{ row }">
          <div class="flex flex-row gap-2">
            <el-icon :size="18" class="cursor-pointer" @click="openDrawer = true"><Edit /></el-icon>
            <el-icon :size="18" color="#e03131" class="cursor-pointer" @click="handleDeleteDocument(row.documentName)"
              ><Delete
            /></el-icon>
          </div>
        </template>
